...
<div id="breadcrumbs">
	<ul class="breadcrumb">
		...
		<li class="active">Tambah Ongkos Kirim</li>
	</ul>
</div>
<!-- END Breadcrumb -->
...
<div class="row">
	<div class="col-md-12">
		<div class="box box-green">
			<div class="box-title">
				<h3><i class="fa fa-edit"></i> Tambah Data Ongkos Kirim </h3>
				<div class="box-tool">
					<a data-action="collapse" href="#"><i class="fa fa-chevron-up"></i></a>
				</div>
			</div>
			<div class="box-content">
				<form method="POST" action="index.php?p=contambahongkoskirim" class="form-horizontal form-row-separated" enctype="multipart/form-data">
					<div class="form-group">
						<label for="textfield3" class="col-sm-3 col-lg-2 control-label">Nama Kota</label>
						<div class="col-sm-9 col-lg-10 controls">
							<input type="text" name="namakota" placeholder="" class="form-control" required autofocus>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-lg-10 controls">
							<input type="text" name="tarif" placeholder="" class="form-control" required autofocus>
						</div>
					</div>
