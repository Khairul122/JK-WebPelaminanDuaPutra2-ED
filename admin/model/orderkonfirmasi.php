								...
								<table class="table table-advance" id="table1">
									...
									<tbody>
										...
										$q = mysql_query(
											...
											WHERE umkm.order.idstatusorder = '2'
											");
										...
										{               
											...
											<tr>
												...
												<td>
													<a href="index.php?p=orderkonfirmasilihat&amp;id=<?php echo $r['idorder']; ?>"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span> Konfirmasi</button></a>
												</td>
											</tr>
											<?php
											$no++;
