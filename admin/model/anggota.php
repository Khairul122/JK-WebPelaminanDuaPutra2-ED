							...
							<div class="table-responsive" style="border:0">
								<table class="table table-advance" id="table1">
									...
									<tbody>
										<?php
										$no = 1;
										$q = mysql_query("SELECT * FROM anggota ORDER BY tgldaftar desc");
										...
										<tr>
											...
											<td width="20%">
												<a href="index.php?p=editanggota&id=<?php echo $r['idanggota']; ?>"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span> Edit</button></a>
